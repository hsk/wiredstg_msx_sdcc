...
void EnemyGetEmpty(void);
void EnemyBombUpdate(void);
void EnemyBombRender(void);
void EnemyFansGenerate(void);
void EnemyFansUpdate(void);
void EnemyRugalGenerate(void);
void EnemyRugalUpdate(void);
void EnemyGarunGenerate(void);
void EnemyGarunUpdate(void);
void EnemyDee01Generate(void);
void EnemyDee01Update(void);
void EnemyDuckerGenerate(void);
void EnemyDuckerUpdate(void);
void EnemyBigCoreGenerate(void);
void EnemyBigCoreUpdateCore(void);
void EnemyBigCoreUpdateBody(void);
void EnemyBigCoreRenderCore(void);
void EnemyBigCoreRenderBody(void);
void EnemyBeamGenerate(void);
void EnemyBeamUpdate(void);
void EnemyBeamRender(void);
// 外部変数宣言
