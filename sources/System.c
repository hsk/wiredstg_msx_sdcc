...
//  三角関数
static char const trigonometricDecimalTable[] = {
    ...
    ,
};
static char const trigonometricIntegerTable[] = {
...
// sin の値を取得する
void SystemGetSin(void) __naked {
    __asm;
    // レジスタの保存
    push    bc
    push    ix
    ...
    ld      c, a
    ld      b, #0x00
    ld      ix, #_trigonometricDecimalTable
    add     ix, bc
    ld      l, 0(ix)
    ld      ix, #_trigonometricIntegerTable
    add     ix, bc
    ld      h, 0(ix)
    // レジスタの復帰
    pop     ix
...
// cos の値を取得する
void SystemGetCos(void) __naked {
    __asm;
    // レジスタの保存
    push    af
    push    bc
